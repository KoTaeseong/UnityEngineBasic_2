...
public class LadderDetector : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireSphere(transform.position + Vector3.up * _upLadderDetectOffset, _detectRadius);

        Gizmos.color = Color.red;
        Gizmos.DrawWireSphere(transform.position + Vector3.down * _downLadderDetectOffset, _detectRadius);
    }
}
