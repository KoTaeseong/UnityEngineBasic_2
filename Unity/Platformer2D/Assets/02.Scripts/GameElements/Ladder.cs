...
public class Ladder : MonoBehaviour
{
    ...
    [SerializeField] private float _ladderUpStartOffsetY = 0.2f;
    [SerializeField] private float _ladderUpEndOffsetY = 0.1f;
    [SerializeField] private float _ladderDownStartOffsetY = 0.2f;
    [SerializeField] private float _ladderDownEndOffsetY = 0.2f;
