...
public class StateLadderDown : State
{
    ...
    {
        StateType next = StateType.LadderDown;
            ...
            case IStateEnumerator<StateType>.Step.Start:
                {
                    ...
                    {
                        //rigidBody.MovePosition( _ladder.ladderDownStartPos);
                        transform.position = _ladder.ladderDownStartPos;
                    }
                    else
                    {
                        //rigidBody.MovePosition(new Vector2(_ladder.transform.position.x, rigidBody.position.y));
            ...
            case IStateEnumerator<StateType>.Step.WaitUntilActionFinished:
                {
                    ...
                    else
                    {
                        ...
                        //rigidBody.MovePosition(rigidBody.position + Vector2.up * vertical * character.ladderMoveSpeed);
